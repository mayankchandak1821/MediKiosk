...
export default function VisualPainScale({ value, onChange, language = 'hi' }) {
  ...
  const painLevels = [
    { level: 0, emoji: '≡ƒÿâ', labelKey: 'painScale.ratings.0', color: 'border-emerald-500 bg-emerald-500/10 text-emerald-400' },
    { level: 2, emoji: '≡ƒÿè', labelKey: 'painScale.ratings.2', color: 'border-emerald-400 bg-emerald-400/10 text-emerald-300' },
    { level: 4, emoji: '≡ƒÿÉ', labelKey: 'painScale.ratings.4', color: 'border-amber-400 bg-amber-400/10 text-amber-300' },
    { level: 6, emoji: '≡ƒÿú', labelKey: 'painScale.ratings.6', color: 'border-orange-500 bg-orange-500/10 text-orange-300' },
    { level: 8, emoji: '≡ƒÿ½', labelKey: 'painScale.ratings.8', color: 'border-rose-500 bg-rose-500/10 text-rose-300' },
    { level: 10, emoji: '≡ƒñ¼', labelKey: 'painScale.ratings.10', color: 'border-red-600 bg-red-600/20 text-rose-400 animate-pulse' }
  ];
